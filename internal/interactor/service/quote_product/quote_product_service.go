...
import (
	...
	db "app.eirc/internal/entity/postgresql/db/quote_products"
	store "app.eirc/internal/entity/postgresql/quote_product"
	model "app.eirc/internal/interactor/models/quote_products"
...
func (s *service) Create(input *model.Create) (output *db.Base, err error) {
	...
	base.QuoteProductID = util.PointerString(uuid.CreatedUUIDString())
