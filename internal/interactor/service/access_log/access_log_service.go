...
import (
	store "app.inherited.caelus/internal/entity/postgresql/access_log"
	db "app.inherited.caelus/internal/entity/postgresql/db/access_logs"
	"encoding/json"

	model "app.inherited.caelus/internal/interactor/models/access_logs"
