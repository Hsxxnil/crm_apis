...
import (
	...
	store "app.eirc/internal/entity/postgresql/account_type"
	db "app.eirc/internal/entity/postgresql/db/account_types"
	model "app.eirc/internal/interactor/models/account_types"
...
func (s *service) Create(input *model.Create) (output *db.Base, err error) {
	...
	base.AccountTypeID = util.PointerString(uuid.CreatedUUIDString())
