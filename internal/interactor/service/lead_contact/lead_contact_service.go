...
import (
	...
	db "app.eirc/internal/entity/postgresql/db/lead_contacts"
	store "app.eirc/internal/entity/postgresql/lead_contact"
	model "app.eirc/internal/interactor/models/lead_contacts"
...
func (s *service) Create(input *model.Create) (output *db.Base, err error) {
	...
	base.LeadContactID = util.PointerString(uuid.CreatedUUIDString())
